# note : l'explication de l'exécution du programme commence à partir de la ligne 564 à 700
# note : l'explication de l'exécution du programme commence à partir de la ligne 564 à 700
# note : l'explication de l'exécution du programme commence à partir de la ligne 564 à 700
# note : l'explication de l'exécution du programme commence à partir de la ligne 564 à 700
# note : l'explication de l'exécution du programme commence à partir de la ligne 564 à 700

from pickle import dumps, loads  # Importing the dumps and loads functions from the pickle module
from sys import getsizeof  # Importing the getsizeof function from the sys module
...
# afficher_fichier_d()
# print(index)
# print(rechercher_d("testBig.txt",index,12))
...
#     print("-1")
#     inserer_d("testBig.txt",index,element)
